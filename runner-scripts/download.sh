...
echo "########################################"
echo "[INFO] Downloading Comfy & Manager..."
echo "########################################"

cd /root
clone_or_pull https://github.com/CavinHuang/comfyui-online-serverless.git

cd /root/comfyui-online-serverless/custom_nodes
